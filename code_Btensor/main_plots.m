...
legendStrings{end+1} = 'ALS - rel L2 error kernel';
...
legendStrings{end+1} = 'ALS - rel Fro error graph';

if isfield(estALS.stats,'err_rel meanL2')
...
legendStrings{end+1} = 'ALS - rel L2 error paths';
...
if runORALS
    ...
    legendStrings{end+1} = 'ORALS - rel L2 error kernel';
    ...
    legendStrings{end+1} = 'ORALS - rel Fro error graph';
    ...
    legendStrings{end+1} = 'ORALS - rel L2 error paths';
end
